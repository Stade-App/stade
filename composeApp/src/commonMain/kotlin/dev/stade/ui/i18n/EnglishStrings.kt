...
object EnglishStrings : AppStrings() {
    ...
    override val updateAvailableTooltip = "New update available"
    override val updateDownloadingTooltip = "Downloading update…"
    override val updateReadyTitle = "Update ready"
    override val updateReadyBody = "Stade will close and the installer will open. Your data stays where it is."
    override val updateInstallAction = "Install now"
    override val updateLaterAction = "Later"
    override val updateFailedTitle = "Could not download the update"
    override val updateFailedBody = "The download failed or did not match its published checksum. You can get it from the releases page instead."
    override val updateOpenPageAction = "Open releases page"
    override val updateSection = "Updates"
    override val updateCheckTitle = "Check for updates"
    override val updateChecking = "Checking…"
    override val updateUpToDate = "You are on the latest version"
    override fun updateFoundVersion(version: String) = "Stade $version is available"
